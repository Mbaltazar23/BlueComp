    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-40">
                <div class="section-title-one"><h1>Todos los productos similiares al buscado</h1></div>
            </div>
            <div class="col-12">
                <div class="shop-product-wrap grid row">
                    ...
                    if (count($arrProductos) > 0) {
                        ...
                        ?>
                        <p class="container">No hay productos en la busqueda ingresada <a href="<?= base_url() ?>/tienda"> Ver productos</a></p>
                    <?php } ?>
